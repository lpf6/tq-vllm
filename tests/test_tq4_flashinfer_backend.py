"""Tests for TQ4 FlashInfer backend.

These tests verify that the TQ4FlashInferBackend correctly implements
...
class TestTQ4FlashInferBackend:
    """Test TQ4FlashInferBackend class."""

    def test_get_name(self):
        """Test backend name."""
        assert TQ4FlashInferBackend.get_name() == "TQ4_FLASHINFER"

    def test_get_kv_cache_shape(self):
        """Test KV cache shape generation."""
        shape = TQ4FlashInferBackend.get_kv_cache_shape(
            num_blocks=100,
            block_size=16,
            num_kv_heads=8,
            head_size=128,
    ...
    def test_forward_includes_kv_cache_update(self):
        ...
        assert TQ4FlashInferBackend.forward_includes_kv_cache_update is True


class TestTQ4FlashInferImpl:
    """Test TQ4FlashInferImpl class."""
